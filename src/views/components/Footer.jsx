                ...
                <div className="row justify-content-between">
                    <div className="col-sm-6 col-md-5">
                        <div className="single-footer-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Mount Everest, India</a></li>
                        ...
                        <div className="single-footer-widget">
                            ...
                            <div className="form-wrap" id="mc_embed_signup">
                                <form target="_blank" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01" method="get" className="form-inline">
                                    ...
                                    <button className="click-btn btn btn-default text-uppercase"><i className="far fa-paper-plane"></i></button>
                    ...
                    <div className="col-sm-6 col-md-3">
                        <div className="single-footer-widget footer_icon">
                            <h4>Contact Us</h4>
                            <p>4156, New garden, New York, USA<br />+880 362 352 783</p>

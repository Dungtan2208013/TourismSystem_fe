                            ...
                            <div className="card-columns">
                                <div className="card">
                                    <a href="img/gallery/gallery_1.png" className="gallery_img">
                                        <img src="img/gallery/gallery_1.png" className="card-img-top" alt="Gallery Image 1" />
                                    </a>
                                </div>
                                <div className="card">
                                    <a href="img/gallery/gallery_3.png" className="gallery_img">
                                        <img src="img/gallery/gallery_3.png" className="card-img-top" alt="Gallery Image 2" />
                                    </a>
                                </div>
                                <div className="card">
                                    <a href="img/gallery/gallery_2.png" className="gallery_img">
                                        <img src="img/gallery/gallery_2.png" className="card-img-top" alt="Gallery Image 3" />
                                    </a>
                                </div>
                                <div className="card">
                                    <a href="img/gallery/gallery_4.png" className="gallery_img">
                                        <img src="img/gallery/gallery_4.png" className="card-img-top" alt="Galler y Image 4" />
                                    </a>
                                </div>
                                <div className="card">
                                    <a href="img/gallery/gallery_5.png" className="gallery_img">
                                        <img src="img/gallery/gallery_5.png" className="card-img-top" alt="Gallery Image 5" />
                                    </a>
                                </div>
                            </div>
                        </div>
